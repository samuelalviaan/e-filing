...
<div class="container">
    ...
    <div class="row">
        ...
        <form action="{{ route('archive.store') }}" class="form-group" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <option class="text-center" value="{{$kode->archive_id}}">{{$kode->kode_arsip}}</option>
                    @endforeach
                    </select>
                </div>
